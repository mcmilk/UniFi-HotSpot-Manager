        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
          <div class="form-group has-feedback">
            <div class="input-group">
              ...
              <input type="number" name="count" min="1" max="500" value="40" class="form-control input-lg" tabindex="1" required data-error="Bitte die Anzahl im Bereich von 1-500 angeben.">
             </div>
